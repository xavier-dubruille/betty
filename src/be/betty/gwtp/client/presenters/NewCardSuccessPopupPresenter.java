...
public class NewCardSuccessPopupPresenter extends
		PresenterWidget<NewCardSuccessPopupPresenter.MyView> {
	...
	@Inject
	public NewCardSuccessPopupPresenter(final EventBus eventBus, final MyView view) {
		super(eventBus, view);
