...
\chapter{Les outils partie cliente}
...
\subsection{Le model View Presenter}
...
\subsection{Local Storage vs Cookies}
...
\subsection{Utilisation dans notre application}
